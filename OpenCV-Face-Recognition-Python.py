...
subjects = ["", "Khuda Buksh", "Mazhar Ali" , "Marwa Roll no: 256" , "Unknown"]
...
# Local Binary Patterns Histogram (LBPH): This can be created with `cv2.face.LBPHFaceRecognizer_create()`
# In[6]:
...
#load test images
test_img1 = cv2.imread("test-data/test5.jpg")
...
#display both images
cv2.imshow("Predicted image", cv2.resize(predicted_img1, (400, 500)))
